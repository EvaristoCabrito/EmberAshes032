...
export function DialogOverlay({ tree, onClose }: { tree: DialogTree; onClose: () => void }) {
  ...
  return (
    <div className="absolute inset-0 z-50 bg-bg/85 flex items-end sm:items-center justify-center p-4">
      <div className="w-full max-w-xl bg-surface border border-accent rounded-xl p-5 flex gap-4">
        {portrait && (
          <img
            src={portrait.src}
            alt=""
